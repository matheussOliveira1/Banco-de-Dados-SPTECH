...
select Experiente.*, Novato.* from Treinador as Experiente join Treinador as Novato on novato.idTreinador = Experiente.fkTreinadorEXP;

select Treinador.*, treinador.nome as treinador from Treinador left join treinadorNovato on Treinador.idTreinador = treinadorNovato.fkTreinadorEXP;

-- exibir os funcionarios, seu supervisor e seus dependentes
select * from funcionario join funcionario as supervisor on supervisor.idFunc = funcionario.fkSupervisor;
